...
function CHANGE_IN_TOTAL_PORTFOLIO_VALUE_NEEDED_FOR_CURRENT_ASSET_VALUE_TO_BE_TARGET_WEIGHT()
{
/**
av = (pv + x) * tw
x = (av / tw) - pv
 ...
 * numberOfTickers              - number of assets/tickers (including those with a target weight of zero)
...
=LET(
    indexNumbersOfNonZeroWeightAssets,
        FILTER(SEQUENCE(numberOfTickers), target_weights > 0),
    numberOfNonZeroWeightAssets,
        COUNTA(indexNumbersOfNonZeroWeightAssets),
